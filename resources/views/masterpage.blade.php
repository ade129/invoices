              ...
              @if (Auth::user()->role_type == "GA")
                  <li class="treeview" id="menu_master">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li id="submenu_invoices"><a href="{{url('invoices')}}"><i class="fa fa-inbox"></i> Add Invoices</a></li>
                      </ul>
                  </li>
                @endif

                <li id="menu_list_invoices"><a href="{{url('invoicestags/')}}"><span class="fa fa-first-order" aria-hidden="true"></span><span>Invoice Payments</span></a></li>
